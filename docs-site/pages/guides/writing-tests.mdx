---
title: Writing Tests
description: Practical YAML test examples for testmcpy — tool selection, parameter validation, multi-step workflows, error handling, and performance.
---

{/* Source: context/guides/writing-tests.md — keep in sync */}

# Writing Tests

Simple, practical examples to get started with testmcpy testing. For the full YAML schema, see [Test Format](/concepts/test-format); for every available check, see [Evaluators](/concepts/evaluators).
...
See [Running Tests](/cli/running-tests) for all CLI options.
...
- [Evaluators](/concepts/evaluators) — learn about all evaluators
- [Test Format](/concepts/test-format) — complete YAML format reference
- [Custom Evaluators](/guides/custom-evaluators) — write your own evaluators
- [CI/CD Integration](/guides/ci-cd-integration) — run tests in CI/CD
