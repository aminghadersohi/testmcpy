---
title: Architecture
description: How testmcpy works under the hood — components, data flow, design patterns, and extensibility points.
---

{/* Source: context/concepts/architecture.md — keep in sync */}
...
See [MCP Profiles](/concepts/mcp-profiles) for full details.
...
See [Evaluators](/concepts/evaluators) for the complete reference.
...
Users can add domain-specific evaluators (see the [Custom Evaluators guide](/guides/custom-evaluators)):
...
- [Configuration](/concepts/configuration) - Configuration system
- [Evaluators](/concepts/evaluators) - Evaluator reference
