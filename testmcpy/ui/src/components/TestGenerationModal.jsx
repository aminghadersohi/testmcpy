...
function TestGenerationModal({ tool, onClose, onSuccess }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-0 sm:p-4">
      <div className="bg-surface border border-border rounded-none sm:rounded-xl shadow-strong sm:max-w-xl md:max-w-2xl lg:max-w-3xl w-full h-full sm:h-auto max-h-full sm:max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
