---
title: Test Format
description: Complete reference for the YAML/JSON test file format — fields, evaluator wiring, organization, and best practices.
---

{/* Source: context/concepts/test-format.md — keep in sync */}

# Test File Format Reference

Complete reference for the YAML/JSON test file format.
...
See the [Evaluator Reference](/concepts/evaluators) for the complete list.
...
testmcpy validates test files against a schema:
...
```yaml
# WRONG - timeout should be integer, not string
timeout: "30"
...
# Avoid overly complex prompts (split into multiple tests)
...
- [Evaluator Reference](/concepts/evaluators) - All available evaluators
- [Writing Tests](/guides/writing-tests) - Guide to writing effective tests
